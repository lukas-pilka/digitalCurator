...
# work_type
workTypeSubstitutes = [
    {'painting':['Pinsel','Deckfarben','Deckfarbe','Pinsel in Grau, grau laviert, über Graphitstift.','akryl','painting2','maliarstvo','malba','Tafelbild (Flügelretabel)','maliarstvo insitné','tempera','Gemälde','obraz','Tafelbild','maliarstvo ľudové','enkaustika','Malerei','Acrylfarbe, Papiermontage auf Karton, Farbstift','Gummitempera']},
    {'oil painting':['olej','Öl auf Papier','Öl','Ölgrisaille','Ölskizze','Ölgrisaille auf rotbraun grundiertem Papier','Ölmalerei']},
    {'watercolor painting':['Bister','Gouache','akvarel','akvarel koláž tuš','akvarel tempera','kvaš','Aquarell','Aquarellskizze auf Elfenbein']},
    {'drawing':['Bleigriffel','kresba', 'Zeichnung','fix','Konturzeichnung','Skizzenbuch','Bleistiftvorzeichnung']},
    {'charcoal drawing':['Kohle','uhel','rudka hnědá','rudka podkresba tužkou','sépie lavírovaná','rudka','coal drawing','Schwarze Kreide','Grafit auf Papier']},
    {'pencil drawing':['Graphitstift','Pastell','Bleistiftzeichnung','pastelka barevná','tužka','pastelka modrá','tužka černá','crayon','Bleistift','Buntstift']},
    {'pastel drawing':['pastel','Pastellkreiden auf braunem Papier']},
    {'chalk drawing':['Graphit','Steinkreide','Kreide','křída','křída barevná','křída barevná nesprašná','křídy barevné','Rötel']},
    {'ink drawing':['Feder','Feder in Grau','Feder in Schwarz','Feder in Braun','laviert','aquarelliert','Tuschfeder','Tusche','Tinte','Silberstift','perokresba','tuš','pero šedohnědě - podkresba tužkou','rudka tuš běloba','lavírovaná tuš tempera','lavírovaná sépií tuš bistrem','kresba perem tuš','inkoust','perokresba lavírovaná']},
    {'graphic print':['světlotisk','Farbholzschnitt','slepotisk','Schrotschnitt, koloriert','Poster','galvanografie','tisk materiálový, kolorovaný','kamenoryt, barevný','linořez, barevný','linoryt, kolorovaný','tisk materiálový, barevný','sítotisk','linořez','tisk','tisk materiálový','linoryt','linoryt, barevný','Grafik','akvatinta','serigrafie','ofset autorský','serigrafie barevná','monotyp','suchá jehla','Kaltnadel','tisk z plochy (ofset)','grafika','Grafika','Druck','počítačová grafika','rytina','mezzotinta','heliogravura','mezzotinta (II. stav)','mezzotinta (I. stav)']},
    {'lithography':['litografie','Lithographie','Farblithographie']},
    {'etching':['Radierung','Radierung, stark übermalt','Radierung und Kaltnadel','Kupferstich, Radierung','Farbradierung','Radierung, Kaltnadel','Radierung, Aquatinta','Aquatinta','Radierung, laviert','měkký kryt (vernis mou)','lept','lept (II. stav)','lept (I. stav)','lept - mědiryt','lept - akvatinta','lept a mědiryt','lept, suchá jehla']},
    {'copper engraving':['mědiryt','mědiryt a lept','mědiryt - lept','Kupferstich']},
    {'steel engraving':['oceloryt']},
    {'woodcut':['dřevoryt','xylografie','dřevořez','Holzschnitt','Holzschnitt, verso Typendruck','Holzschnitt, koloriert','Holzschnitt; Blatt ist bis zum Plattenrand beschnitten','Holzschnitt und Typendruck']},
    ...
    {'other':['sépie','Sepia','perforace','jiná technika, klišé','jiná technika','koláž','mosaika','asambláž','interpretácia','alchymáž','kombinovaná technika','Glasbild','Mischtechnik']}
]
...
def setNewValues(phrasesForReplace):
    for phrasesSet in phrasesForReplace:
        ...
        payload = {'size': 10000}
        rawData = requests.post('https://66f07727639d4755971f5173fb60e420.europe-west3.gcp.cloud.es.io:9243/artworks_alias/_update_by_query',
